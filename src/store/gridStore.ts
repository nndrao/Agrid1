...
// Add the interface for additional properties we need for conditional formatting
interface ExcelFormatParams {
  ...
  colDef?: any & {
    __cellColor?: string;
    __useColor?: boolean;
    __conditionMet?: boolean;
    __useCondition?: boolean;
    __conditionOperator?: string;
    __conditionValue?: number;
    __switchCaseValue?: string;
    __matchedCase?: string;
    __useSwitchCase?: boolean;
  };
  [key: string]: any;
}

// Simplify the applyExcelFormat function to only handle string formatting
                ...
                colDef.cellStyle = (params: any) => {
                  try {
                    ...
                    if (columnSettings?.formatter?.formatterType === 'Custom' &&
                      ...
                      // Get cell color from format
                      const cellColor = calculateCellColor(customFormat, value);
                      
                      // Return color style if found
                      if (cellColor) {
